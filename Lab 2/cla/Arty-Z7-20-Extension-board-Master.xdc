...
## RGB LEDs
set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { led[4] }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports { led[5] }]; #IO_0_35 Sch=LED5_B
